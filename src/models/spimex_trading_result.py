...
class SpimexTradingResult(Base):
    ...
    exchange_product_id: Mapped[str] = mapped_column(String, nullable=False, unique=False)
    exchange_product_name: Mapped[str] = mapped_column(String, nullable=True)
    ...
    delivery_basis_name: Mapped[str] = mapped_column(String, nullable=True)
